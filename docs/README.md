...
Stand: 04.09.2026 · öffentlicher Release `1.0.1` plus klar abgegrenzter Zielstand `1.0.2`
...
| Dokument | Zweck |
|---|---|
| [`KRUXX-IST-STAND.md`](KRUXX-IST-STAND.md) | Release-Status von KruXx 1.0.1 und davon getrennter Zielstand 1.0.2 |
