...
class PoTokenWebView private constructor(
    ...
    init {
            ...
            override fun onConsoleMessage(m: ConsoleMessage): Boolean {
                ...
                if (msg.contains("Uncaught")) {
                    ...
                    if (initResumed.get()) {
                        ...
                        logger.e("Uncaught JavaScript error after initialization")
                        isDead = true
                        ...
                        logger.e("This WebView implementation is unavailable")
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun onRenderProcessGone(view: WebView, detail: RenderProcessGoneDetail): Boolean {
                ...
                logger.e("PoToken WebView render process gone (didCrash=$didCrash)")
                isDead = true
    ...
    fun onJsInitializationError(error: String) {
        if (BuildConfig.DEBUG) {
            logger.e("PO-token JavaScript initialization failed")
        }
    ...
    fun onRunBotguardResult(botguardResponse: String) {
        ...
        makeBotguardServiceRequest(
            ...
            logger.d("GenerateIT response received")
            try {
                val (integrityToken, expirationTimeInSeconds) = parseIntegrityTokenData(responseBody)
                logger.d("Parsed integrity token; expires in $expirationTimeInSeconds sec")
                ...
                logger.e("Failed to parse integrity token data type=${e::class.simpleName ?: "unknown"}")
    ...
    suspend fun generatePoToken(identifier: String): String {
        ...
        return try {
            ...
            logger.e("PO-token generation timed out after ${GENERATE_TIMEOUT_MS}ms")
    ...
    private suspend fun generatePoTokenInternal(identifier: String, requestKey: String): String {
        return withContext(Dispatchers.Main) {
            suspendCancellableCoroutine { cont ->
                logger.d("PO-token generation requested")
    ...
    fun onObtainPoTokenError(requestKey: String, error: String) {
        if (BuildConfig.DEBUG) {
            logger.e("PO-token JavaScript callback failed")
        }
    ...
    fun onObtainPoTokenResult(requestKey: String, poTokenU8: String) {
        logger.d("Encoded PO-token result received")
        val poToken = try {
    ...
    private fun destroyWebView() {
        ...
        runCatching {
            ...
            webView.destroy()
        }.onFailure { logger.w("PO-token WebView teardown failed type=${it::class.simpleName ?: "unknown"}") }
    }
    //endregion
    ...
    companion object {
        ...
        // Kreate: reuse the app-wide OkHttp client (proxy, DoH, logging) via Koin
        private val httpClient: OkHttpClient by lazy { KoinJavaComponent.get(OkHttpClient::class.java) }
        ...
        suspend fun getNewPoTokenGenerator(context: Context): PoTokenWebView {
            ...
            try {
                ...
                logger.e("PoTokenWebView init timed out after ${INIT_TIMEOUT_MS}ms")
