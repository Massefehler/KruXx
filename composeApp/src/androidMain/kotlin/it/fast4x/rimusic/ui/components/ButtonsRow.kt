...
fun <E> ButtonsRow(
    ...
    Row(
        ...
        HorizontalScrollWithArrows(Modifier.weight(1f), scrollState) { scrollModifier ->
            Row(
                ...
                chips.forEach { (value, label) ->
                    key(value) {
                        ...
                        LaunchedEffect(selected, scrollState.viewportSize, scrollState.maxValue) {
                            if (BuildConfig.INDEPENDENT_FORK && selected) bringIntoView.bringIntoView()
                        }
                        FilterChip(
